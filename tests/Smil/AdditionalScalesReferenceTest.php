...
/**
 * Независимые reference cases партий 05.S3.1, 05.S3.2 и 05.S3.3 (WP5).
 *
...
final class AdditionalScalesReferenceTest extends TestCase
{
    ...
    public function testFixtureDocumentsItsIndependentProvenance(): void
    {
        ...
        self::assertCount(55, $provenance['entries']);
        self::assertCount(55, $provenance['batches']);
        self::assertSame(
            ['05.S3.1' => 16, '05.S3.2' => 19, '05.S3.3' => 20],
