...
final class AdditionalScalesInvariantsTest extends TestCase
{
    ...
    /**
     * Партия 05.S3.5: 29 оставшихся записей приложения, утверждены владельцем 15.09.2026.
     *
     * Партия закрывает приложение целиком, кроме восьми отложенных записей: №9, 58, 72, 167
     ...
     */
    private const NOTE_EXCEPTIONS = [47, 50, 52, 55, 74, 87, 162, 177, 205];
    ...
    {
        self::assertCount(104, $this->scales);
