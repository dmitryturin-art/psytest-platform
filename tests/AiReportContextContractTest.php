...
final class AiReportContextContractTest extends TestCase
{
    ...
    public function testGlossaryKeepsTheContextSmallEnoughToSend(): void
    {
        ...
        // 07.G5 уточнил тексты 18 записей и ссылки на источники, порог тот же.
        // Фактический размер на эталонном профиле — 58 690 знаков.
        self::assertLessThan(60000, mb_strlen($json), 'Нагрузка СМИЛ перестала быть компактной.');
    }
