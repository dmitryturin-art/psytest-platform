...
- автоматический quality gate на PHP 8.3: быстрые тесты и статические проверки выполняются один раз, а миграции и DB-тесты — на MySQL 5.7 и 8.0 для изменений слоя данных и каждого обновления `main`.
