#!/usr/bin/env python3
"""Независимые эталоны дополнительных шкал СМИЛ (партии 05.S3.1-05.S3.4).
...
# Партия -> (номер записи транскрипции -> runtime-код). Все четыре утверждены 15.09.2026.
...
# Плоский список в порядке вывода: партии 1, 2, 3, 4, внутри партии — по номеру записи.
BATCH = [
    (number, code, batch)
...
def main() -> None:
    ...
    output = {
        "title": "Независимые эталоны дополнительных шкал СМИЛ, партии 05.S3.1-05.S3.4",
