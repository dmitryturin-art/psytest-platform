 ...
 *
 * Партии задаются списком BATCHES: 05.S3.1 (16 записей) и 05.S3.2 (19 клинических
...
$output = [
    ...
    'note' => 'Партия 05.S3.1: 16 записей. Партия 05.S3.2: 19 клинических подшкал. Все 35 — verified; '
        . 'у №87 есть поле note про опечатку «верно/неверно» в источнике, состав ключа подтверждён '
        . 'сверкой с Harris–Lingoes Hy4. №72 «Предипохондрическое состояние» выведена: её нормы — '
