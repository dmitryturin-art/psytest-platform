...
- Решения: отдельный лендинг объясняет бесплатный результат и дополнительный разбор, показывает честные обезличенные примеры и скромно ссылается на 23time.ru; аккаунт добровольный, anonymous result links сохраняются.
