...
- Этап / ветка / commit: этап 02, `codex/02-bdi-crisis-notice`, commit ожидается.
...
- Следующий шаг: review, commit/push и дождаться CI.
