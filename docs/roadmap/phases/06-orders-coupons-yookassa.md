...
Статус: **Не начат, идёт после этапа 07** (решение владельца D-037 от 26.08.2026). Зависит от security/privacy gates; production включается только после sandbox и фискального согласования.

По D-037 платёжный контур подключается к уже работающему бесплатному ИИ-разбору как переключатель доступа: к моменту старта этапа генерация, кабинет и доставка отчёта уже должны работать, и задача этапа — учёт заказов, купоны, entitlement и фискальная часть, а не запуск самого разбора.
