...
3. **Staging.** 08.1B исправил public-root rewrite. 08.1C добавил полный CI на MySQL 5.7/8.0 и устранил несовместимость expiry columns. Далее: deployment artifact, отдельные secrets, HTTPS и access restriction.
