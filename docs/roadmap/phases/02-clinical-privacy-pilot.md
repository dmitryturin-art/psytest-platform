...
7. **Методики и лицензии.** 02.5A создаёт versioned registry текущих модулей: factual evidence, gaps и release gates. Пока право конкретной формы не подтверждено, не добавлять новый public content и не включать paid interpretation; существующие scoring core и бесплатный flow не меняются.
