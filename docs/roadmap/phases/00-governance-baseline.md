...
Статус: **Закрыт 25.08.2026**. Все exit criteria выполнены: документация связана и не противоречит решениям, governance-пакеты закоммичены, baseline воспроизводим (148/148, cap 148), DOC-01 закрыт для локальной разработки. Финальные штрихи — 00F–00M (включая применение ревью от 25.08). Продуктовый код в governance-пакете не меняется.
