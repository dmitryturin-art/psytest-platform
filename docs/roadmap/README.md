...
Для команды **«Продолжай PsyTest»**: [инструкция исполнителю](START_HERE.md).
Главная точка входа — [`ROADMAP.md`](../../ROADMAP.md).

## Управление

- [Текущий статус](STATUS.md) — активный этап, ветка, ближайшие действия и блокеры.
- [Протокол checkpoint](CHECKPOINT.md) — порядок фиксации состояния перед паузой.
...
СМИЛ (все подтверждённые дополнительные шкалы) и кабинеты ведутся параллельно; свободные аналоги сохраняются третьей линией. Исполнимые пакеты S/K/O и зависимости — [ревью](../audit/2026-09-08-delivery-review.md). Начать S1 + K0, затем K1. IPIP не заменяет СМИЛ.
