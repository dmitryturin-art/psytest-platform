...
| DATA-01 | Privacy claims расходятся с plaintext/внешним AI | P0 | 02/07 | 02.4A: factual public privacy/delete copy и `PrivacyClaimsTruthfulnessTest` запрещают ложные claims о шифровании, отсутствии будущих получателей и полном мгновенном удалении; остаются legal review, minimization IP/user-agent и AI consent/provider boundary | В работе |
