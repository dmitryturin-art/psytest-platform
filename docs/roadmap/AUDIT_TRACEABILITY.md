...
| CLIN-01 | BDI item 9 не создаёт самостоятельный crisis signal | P0 | 02 | В работе: 02.2A `ClinicalSafetySignal` создаёт structured signal из валидированного item 9 при низком total; unit/module regressions. Нужны Crisis UI, country/resources и browser cases после owner-approved текста | В работе |
