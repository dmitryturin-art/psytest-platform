...
1. Ранняя проверка формата входа: первый реальный вызов провайдера на синтетической фикстуре Лазаруса, затем сравнение с тем, что владелец получает своим ручным способом.
