...
- Ревью от 25.08 ([docs/audit/2026-08-25-project-review.md](../audit/2026-08-25-project-review.md)) подтвердило зелёный gate и выдало приоритизированный план. Выполнено 00L: устаревшие дубли документации (архитектурный черновик февраля, DEPLOYMENT с retired AI-flow, QUICKSTART с PHP 8.2) архивированы с баннером «не исполнять», полный gate в `AGENTS.md` дополнен обязательным `composer migrate` перед тестами. Дальше по плану ревью: нативная визуализация парного сравнения Лазаруса на web-странице пары вместо мёртвого Chart.js-контура; судьба legacy `services/*` и число активных этапов ждут решения владельца.
