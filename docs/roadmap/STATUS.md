...
- Состояние: этап 01 завершён; для этапа 02 приняты retention (180 дней / бессрочный therapist-режим) и отдельный AI-consent. 02.1 anonymous lifecycle подтверждён локальным и GitHub PHP 8.3 gate.
