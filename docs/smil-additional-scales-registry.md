...
**Статус:** инвентарь S1 от 09.09.2026; транскрипция S2, партии S3.1, S3.2 и S3.3 от 15.09.2026 — [smil-additional-scales-transcription.json](smil-additional-scales-transcription.json). Это не публикация новых ключей, не корректировка
...
(`verified (S3.3)`). Запись №72 из партии 2 выведена: её нормы — дубль строки №74, то есть
собственные нормы в этом издании утрачены. Остальные 57 записей остаются `missing`
до следующих партий.
...
прежние списки. `additional_scales_count` в metadata модуля — 55 после 05.S3.3
(16 после 05.S3.1, 35 после 05.S3.2), число «200+» из модуля и README убрано.
