...
Запись №72 из партии выведена: её нормы — дубль строки №74, то есть собственные нормы
в этом издании утрачены. Остальные 77 записей остаются `missing` до следующих партий.
...
`modules/smil/additional-scales-v2.json` — **35 шкал: 16 партии 05.S3.1 и 19 партии
...
в metadata модуля — 35. Все 35 имеют статус `verified`.
...
переименован из `smil-additional-batch1-reference.json` и покрывает **все 35 шкал**:
