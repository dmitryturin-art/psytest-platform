...
class SmilModule extends BaseTestModule
{
    ...
    protected function renderRecommendationsSection(array $interpretation): string
    {
        ...
        $html .= '<p><strong>⚠️ Важно:</strong> Данная интерпретация носит ознакомительный характер и не является клиническим диагнозом. СМИЛ (MMPI) — это скрининговый инструмент. Для постановки диагноза и назначения лечения обратитесь к квалифицированному специалисту (клиническому психологу, психотерапевту, психиатру).</p>';
        $html .= '</div>';
